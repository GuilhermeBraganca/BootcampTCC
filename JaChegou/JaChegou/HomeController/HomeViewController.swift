...
#warning("criar metodo para configurações!!!")
...
#warning("deveria estar na viewModel!!!")
...
#warning("você tem o metodo na vm e chama propriedades da viewModel??")
...
#warning("remover codigo comentado")
