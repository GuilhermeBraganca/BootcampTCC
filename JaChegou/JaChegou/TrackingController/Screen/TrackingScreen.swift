...
class TrackingScreen: UIView {
    ...
    func configConstraints() {
      NSLayoutConstraint.activate([
        ...
        subTitleLabelTrackingScreen.centerXAnchor.constraint(equalTo: centerXAnchor),

        trackingCodeTextField.topAnchor.constraint(equalTo: subTitleLabelTrackingScreen.bottomAnchor, constant: 20),
        ...
        saveButton.topAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor, constant: -60),
